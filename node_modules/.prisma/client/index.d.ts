  ...
  */
  ...
  export type UserGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        P extends 'role' ? RolesGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'role' ? RolesGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof User ? User[P] : never
  } 
    : User
  : User
  ...
  export type RolesGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends '_count' ? RolesCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'User' ? Array < UserGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends '_count' ? RolesCountOutputTypeGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof Roles ? Roles[P] : never
  } 
    : Roles
  : Roles
  ...
  export interface RolesDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Roles'> extends True ? CheckSelect<T, Prisma__RolesClient<Roles>, Prisma__RolesClient<RolesGetPayload<T>>> : CheckSelect<T, Prisma__RolesClient<Roles | null, null>, Prisma__RolesClient<RolesGetPayload<T> | null, null>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Roles'> extends True ? CheckSelect<T, Prisma__RolesClient<Roles>, Prisma__RolesClient<RolesGetPayload<T>>> : CheckSelect<T, Prisma__RolesClient<Roles | null, null>, Prisma__RolesClient<RolesGetPayload<T> | null, null>>
    ...
    **/
    ...
    /**
     * Find one Roles that matches the filter or throw
     * `NotFoundError` if no matches were found.
   ...
   */
  export type RolesFindUniqueOrThrowArgs = RolesFindUniqueArgsBase
      

  /**
   * Roles: findFirstOrThrow
   */
  export type RolesFindFirstOrThrowArgs = RolesFindFirstArgsBase
